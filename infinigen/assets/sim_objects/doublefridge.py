...
def nodegroup_handle(nw: NodeWrangler):
    ...
    store_named_attribute = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": curve_to_mesh, "Name": "joint3"},
        attrs={"data_type": "INT"},
    )
    ...
    store_named_attribute_1 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": transform_geometry, "Name": "joint4"},
        attrs={"data_type": "INT"},
    )
    ...
    store_named_attribute_2 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": transform_geometry_1, "Name": "joint4", "Value": 1},
        attrs={"data_type": "INT"},
    )
    ...
    store_named_attribute_3 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": delete_geometry, "Name": "joint3", "Value": 1},
        attrs={"data_type": "INT"},
    )
...
def nodegroup_two_material_cube(nw: NodeWrangler):
    ...
    store_named_attribute = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": set_material_1, "Name": "joint7"},
        attrs={"data_type": "INT"},
    )
    ...
    store_named_attribute_1 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": set_material, "Name": "joint7", "Value": 1},
        attrs={"data_type": "INT"},
    )
...
def nodegroup_shelf(nw: NodeWrangler):
    ...
    store_named_attribute = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": multipleobjects, "Name": "switch1"},
        attrs={"data_type": "INT"},
    )
    ...
    store_named_attribute_1 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": multipleobjects_1, "Name": "switch1", "Value": 1},
        attrs={"data_type": "INT"},
    )
...
def nodegroup_multi_drawer(nw: NodeWrangler):
    ...
    store_named_attribute_3 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": set_material, "Name": "joint1"},
        attrs={"data_type": "INT"},
    )
    ...
    store_named_attribute = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": set_material_2, "Name": "joint2"},
        attrs={"data_type": "INT"},
    )
    ...
    store_named_attribute_2 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": join_geometry_1, "Name": "joint1", "Value": 1},
        attrs={"data_type": "INT"},
    )
...
@node_utils.to_nodegroup(
    "nodegroup_doublefridge", singleton=False, type="GeometryNodeTree"
)
def nodegroup_doublefridge(nw: NodeWrangler):
    # Code generated using version 2.6.5 of the node_transpiler
    ...
    separate_xyz_5 = nw.new_node(
        Nodes.SeparateXYZ, input_kwargs={"Vector": group_input_4.outputs["Size"]}
    )

    separate_xyz_12 = nw.new_node(
        Nodes.SeparateXYZ,
        input_kwargs={"Vector": group_input_4.outputs["DoorShelfSize"]},
    )

    separate_xyz_6 = nw.new_node(
        Nodes.SeparateXYZ,
        input_kwargs={"Vector": group_input_4.outputs["DrawerHandleTopSize"]},
    )

    separate_xyz_7 = nw.new_node(
        Nodes.SeparateXYZ,
        input_kwargs={"Vector": group_input_4.outputs["DrawerHandleSupportSize"]},
    )
    ...
    add_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: separate_xyz_12.outputs["Z"], 1: add}
    )

    multiply = nw.new_node(
        Nodes.Math,
        input_kwargs={0: group_input_4.outputs["WallThickness"], 1: 2.0000},
        attrs={"operation": "MULTIPLY"},
    )
    ...
    subtract = nw.new_node(
        Nodes.Math,
        input_kwargs={0: separate_xyz_5.outputs["X"], 1: add_2},
        attrs={"operation": "SUBTRACT"},
    )

    subtract_1 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: separate_xyz_5.outputs["Y"], 1: multiply},
        attrs={"operation": "SUBTRACT"},
    )
    ...
    combine_xyz_10 = nw.new_node(
        ...
        input_kwargs={
            "X": subtract,
            "Y": subtract_1,
            "Z": group_input_4.outputs["DrawerHeight"],
        },
    )

    reroute_3 = nw.new_node(
        Nodes.Reroute, input_kwargs={"Input": group_input_4.outputs["DrawerMaterial"]}
    )
    ...
    multidrawer = nw.new_node(
        ...
        input_kwargs={
            "Size": combine_xyz_10,
            "WallThickness": group_input_4.outputs["DrawerWallThickness"],
            "HandleMargin": group_input_4.outputs["DrawerHandleMargin"],
            "HandleTopSize": group_input_4.outputs["DrawerHandleTopSize"],
            "HandleTopThickness": group_input_4.outputs["DrawerHandleTopThickness"],
            "HandleTopRoundness": group_input_4.outputs["DrawerHandleTopRoundness"],
            "HandleSupportSize": group_input_4.outputs["DrawerHandleSupportSize"],
            "HandleSupportMargin": group_input_4.outputs["DrawerHandleSupportMargin"],
            "SlidingJointValue": group_input_4.outputs["DrawerSlidingJointValue"],
            "BodyRoundness": group_input_4.outputs["DrawerBodyRoundness"],
            "SlideRoundness": group_input_4.outputs["DrawerSlideRoundness"],
            "InnerRoundness": group_input_4.outputs["DrawernnerRoundness"],
            "InnerMaterial": reroute_3,
            "OuterMaterial": reroute_3,
            "HandleMaterial": group_input_4.outputs["DrawerHandleMaterial"],
            "DrawerNum": group_input_4.outputs["DrawerNum"],
        },
    )
    ...
    add_4 = nw.new_node(Nodes.Math, input_kwargs={0: add_3, 1: multiply_3})

    subtract_2 = nw.new_node(
        Nodes.Math,
        input_kwargs={
            0: separate_xyz_5.outputs["Z"],
            1: group_input_4.outputs["DrawerHeight"],
        },
        attrs={"operation": "SUBTRACT"},
    )
    ...
    multiply_4 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: subtract_2, 1: -0.5000},
        attrs={"operation": "MULTIPLY"},
    )

    add_5 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: multiply_4, 1: group_input_4.outputs["WallThickness"]},
    )

    combine_xyz_12 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": add_4, "Z": add_5}
    )
    ...
    store_named_attribute = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": transform_geometry_5, "Name": "switch0", "Value": 1},
        attrs={"data_type": "INT"},
    )
    ...
    switch = nw.new_node(
        Nodes.Switch,
        input_kwargs={
            "Switch": group_input_4.outputs["DrawerOnBottom"],
    ...
    store_named_attribute_1 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": switch, "Name": "joint0"},
        attrs={"data_type": "INT"},
    )
    ...
    add_6 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: group_input_4.outputs["ShelfMargin"], 1: multiply_5},
    )

    add_7 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: group_input_4.outputs["DrawerHeight"], 1: multiply_5},
    )

    combine_xyz_11 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": add_6, "Y": multiply_5, "Z": add_7}
    )

    subtract_3 = nw.new_node(
        Nodes.VectorMath,
        input_kwargs={0: group_input_4.outputs["Size"], 1: combine_xyz_11},
        attrs={"operation": "SUBTRACT"},
    )
    ...
    shelf = nw.new_node(
        ...
        input_kwargs={
            "Size": subtract_3.outputs["Vector"],
            "LayerNum": group_input_4.outputs["ShelfLayerNum"],
            "ShelfThickness": group_input_4.outputs["ShelfThickness"],
            "BoardMargin": group_input_4.outputs["ShelfBoardMargin"],
            "NetFBINum": group_input_4.outputs["ShelfNetFBNum"],
            "NetLRNum": group_input_4.outputs["ShelfNetLRNum"],
            "NettedShelf": group_input_4.outputs["ShelfNettedShelf"],
            "InnerMaterial": group_input_4.outputs["ShelfGlassMaterial"],
            "OuterMaterial": group_input_4.outputs["ShelfMaterial"],
        },
    )
    ...
    multiply_6 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: group_input_4.outputs["ShelfMargin"], 1: -0.5000},
        attrs={"operation": "MULTIPLY"},
    )

    add_8 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: multiply_6, 1: group_input_4.outputs["WallThickness"]},
    )

    multiply_7 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: group_input_4.outputs["DrawerHeight"]},
        attrs={"operation": "MULTIPLY"},
    )

    combine_xyz_7 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": add_8, "Z": multiply_7}
    )
    ...
    store_named_attribute_2 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": transform_geometry_2, "Name": "joint0", "Value": 1},
        attrs={"data_type": "INT"},
    )

    string = nw.new_node("FunctionNodeInputString", attrs={"string": "joint5"})

    string_1 = nw.new_node("FunctionNodeInputString", attrs={"string": "joint8"})

    size = nw.new_node(
        Nodes.Reroute,
        input_kwargs={"Input": group_input_4.outputs["Size"]},
        label="Size",
    )
    ...
    thickness = nw.new_node(
        Nodes.Reroute,
        input_kwargs={"Input": group_input_4.outputs["WallThickness"]},
        label="Thickness",
    )
    ...
    openroundcube = nw.new_node(
        ...
        input_kwargs={
            "Size": combine_xyz,
            "Thickness": thickness,
            "OuterRoundness": group_input_4.outputs["BodyOuterRoundness"],
            "InnerRoundness": group_input_4.outputs["BodyInnerRoundness"],
        },
    )
    ...
    set_material = nw.new_node(
        ...
        input_kwargs={
            "Geometry": openroundcube,
            "Material": group_input_4.outputs["BodyMaterial"],
        },
    )
    ...
    store_named_attribute_11 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": add_jointed_geometry_metadata, "Name": "joint8"},
        attrs={"data_type": "INT"},
    )
    ...
    combine_xyz_1 = nw.new_node(
        Nodes.CombineXYZ,
        input_kwargs={
            "X": group_input_4.outputs["WallThickness"],
            "Y": multiply_8,
    ...
    twomaterialcube = nw.new_node(
        ...
        input_kwargs={
            "Size": combine_xyz_1,
            "LMargin": group_input_4.outputs["DoorLMargin"],
            "RMargin": group_input_4.outputs["DoorRMargin"],
            "UMargin": group_input_4.outputs["DoorUMargin"],
            "BMargin": group_input_4.outputs["DoorBMargin"],
            "InnerMaterial": group_input_4.outputs["DoorGlassMaterial"],
            "OuterMaterial": group_input_4.outputs["BodyMaterial"],
        },
    )

    store_named_attribute_7 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": twomaterialcube, "Name": "joint9"},
        attrs={"data_type": "INT"},
    )
    ...
    openroundcube_1 = nw.new_node(
        nodegroup_open_round_cube().name,
        input_kwargs={
            "Size": group_input_4.outputs["DoorShelfSize"],
            "Thickness": group_input_4.outputs["DoorShelfThickness"],
            "OuterRoundness": group_input_4.outputs["DoorShelfOuterRoundness"],
            "InnerRoundness": group_input_4.outputs["DoorShelfInnerRoundness"],
        },
    )
    ...
    subtract_5 = nw.new_node(
        ...
        input_kwargs={
            ...
            1: group_input_4.outputs["DoorShelfMargin"],
        },
        attrs={"operation": "SUBTRACT"},
    )
    ...
    combine_xyz_9 = nw.new_node(
        ...
        input_kwargs={
            "X": 1.0000,
            "Y": 1.0000,
            "Z": group_input_4.outputs["DoorShelfNum"],
        },
    )
    ...
    set_material_2 = nw.new_node(
        ...
        input_kwargs={
            "Geometry": transform_geometry_3,
            "Material": group_input_4.outputs["DoorShelfMaterial"],
        },
    )

    store_named_attribute_8 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": set_material_2, "Name": "joint9", "Value": 1},
        attrs={"data_type": "INT"},
    )

    reroute_4 = nw.new_node(
        Nodes.Reroute,
        input_kwargs={"Input": group_input_4.outputs["DoorHandleTopSize"]},
    )
    ...
    handle = nw.new_node(
        ...
        input_kwargs={
            "TopSize": reroute_4,
            "TopThickness": group_input_4.outputs["DoorHandleTopThickness"],
            "TopRoundness": group_input_4.outputs["DoorHandleTopRoundness"],
            "SupportSize": group_input_4.outputs["DoorHandleSupportSize"],
            "SupportMargin": group_input_4.outputs["DoorHandleSupportMargin"],
    ...
    separate_xyz_8 = nw.new_node(
        Nodes.SeparateXYZ,
        input_kwargs={"Vector": group_input_4.outputs["DoorHandleSupportSize"]},
    )

    add_9 = nw.new_node(
        Nodes.Math, input_kwargs={0: multiply_10, 1: separate_xyz_8.outputs["Z"]}
    )
    ...
    separate_xyz_2 = nw.new_node(
        Nodes.SeparateXYZ, input_kwargs={"Vector": subtract_6.outputs["Vector"]}
    )
    ...
    subtract_7 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: multiply_11, 1: group_input_4.outputs["DoorHandleMargin"]},
        attrs={"operation": "SUBTRACT"},
    )
    ...
    map_range_1 = nw.new_node(
        Nodes.MapRange,
        input_kwargs={
            "Value": group_input_4.outputs["DoorOnRight"],
            3: 1.0000,
            4: -1.0000,
        },
    )
    ...
    multiply_12 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: subtract_7, 1: map_range_1.outputs["Result"]},
        attrs={"operation": "MULTIPLY"},
    )

    combine_xyz_6 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": add_9, "Y": multiply_12}
    )
    ...
    store_named_attribute_9 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": transform_geometry_1, "Name": "joint9", "Value": 2},
        attrs={"data_type": "INT"},
    )
    ...
    reroute_2 = nw.new_node(
        Nodes.Reroute, input_kwargs={"Input": group_input_4.outputs["DoorOnRight"]}
    )
    ...
    multiply_15 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: subtract_8, 1: multiply_14},
        attrs={"operation": "MULTIPLY"},
    )

    combine_xyz_3 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": multiply_13, "Y": multiply_15}
    )
    ...
    multiply_18 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: multiply_17, 1: map_range.outputs["Result"]},
        attrs={"operation": "MULTIPLY"},
    )

    combine_xyz_4 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": multiply_16, "Y": multiply_18}
    )
    ...
    add_10 = nw.new_node(
        Nodes.VectorMath,
        input_kwargs={0: combine_xyz_4, 1: subtract_9.outputs["Vector"]},
    )

    combine_xyz_5 = nw.new_node(Nodes.CombineXYZ, input_kwargs={"Z": multiply_18})
    ...
    store_named_attribute_12 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": hinge_joint.outputs["Geometry"], "Name": "joint5"},
        attrs={"data_type": "INT"},
    )
    ...
    multiply_19 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: separate_xyz_13.outputs["Y"]},
        attrs={"operation": "MULTIPLY"},
    )
    ...
    combine_xyz_13 = nw.new_node(
        ...
        input_kwargs={
            "X": group_input_4.outputs["WallThickness"],
            "Y": multiply_19,
            "Z": separate_xyz_13.outputs["Z"],
        },
    )

    twomaterialcube_1 = nw.new_node(
        nodegroup_two_material_cube().name,
        input_kwargs={
            "Size": combine_xyz_13,
            "LMargin": group_input_4.outputs["DoorRMargin"],
            "RMargin": group_input_4.outputs["DoorLMargin"],
            "UMargin": group_input_4.outputs["DoorUMargin"],
            "BMargin": group_input_4.outputs["DoorBMargin"],
            "InnerMaterial": group_input_4.outputs["DoorGlassMaterial"],
            "OuterMaterial": group_input_4.outputs["BodyMaterial"],
    ...
    store_named_attribute_3 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": twomaterialcube_1, "Name": "joint6"},
        attrs={"data_type": "INT"},
    )

    openroundcube_2 = nw.new_node(
        nodegroup_open_round_cube().name,
        input_kwargs={
            "Size": group_input_4.outputs["DoorShelfSize"],
            "Thickness": group_input_4.outputs["DoorShelfThickness"],
    ...
    separate_xyz_15 = nw.new_node(
        Nodes.SeparateXYZ, input_kwargs={"Vector": combine_xyz_13}
    )

    subtract_10 = nw.new_node(
        Nodes.Math,
        input_kwargs={
            0: separate_xyz_15.outputs["Z"],
            1: group_input_4.outputs["DoorShelfMargin"],
        },
        attrs={"operation": "SUBTRACT"},
    )
    ...
    combine_xyz_18 = nw.new_node(
        Nodes.CombineXYZ,
        input_kwargs={
            "X": separate_xyz_16.outputs["X"],
            "Y": separate_xyz_15.outputs["Y"],
            "Z": subtract_10,
        },
    )

    sizeofobject_1 = nw.new_node(
        nodegroup_size_of_object().name, input_kwargs={"Geometry": transform_geometry_8}
    )
    ...
    multipleobjects_1 = nw.new_node(
        nodegroup_multiple_objects().name,
        input_kwargs={
            "Object": transform_geometry_8,
            "SpaceSize": combine_xyz_18,
            "ObjectSize": sizeofobject_1,
            "ObjectNum": combine_xyz_20,
        },
    )

    movetoorigin_2 = nw.new_node(
        nodegroup_move_to_origin().name, input_kwargs={"Geometry": multipleobjects_1}
    )

    combine_xyz_19 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": separate_xyz_16.outputs["Z"]}
    )

    multiply_20 = nw.new_node(
        Nodes.VectorMath,
        input_kwargs={0: combine_xyz_19, 1: (-0.5000, -0.5000, -0.5000)},
        attrs={"operation": "MULTIPLY"},
    )
    ...
    transform_geometry_9 = nw.new_node(
        Nodes.Transform,
        input_kwargs={
            "Geometry": movetoorigin_2,
            "Translation": multiply_20.outputs["Vector"],
        },
    )
    ...
    store_named_attribute_4 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": set_material_3, "Name": "joint6", "Value": 1},
        attrs={"data_type": "INT"},
    )
    ...
    separate_xyz_18 = nw.new_node(
        Nodes.SeparateXYZ, input_kwargs={"Vector": combine_xyz_13}
    )

    multiply_21 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: separate_xyz_18.outputs["X"]},
        attrs={"operation": "MULTIPLY"},
    )
    ...
    add_11 = nw.new_node(
        Nodes.Math, input_kwargs={0: multiply_21, 1: separate_xyz_17.outputs["Z"]}
    )

    subtract_11 = nw.new_node(
        Nodes.VectorMath,
        input_kwargs={0: combine_xyz_13, 1: reroute_6},
        attrs={"operation": "SUBTRACT"},
    )

    separate_xyz_14 = nw.new_node(
        Nodes.SeparateXYZ, input_kwargs={"Vector": subtract_11.outputs["Vector"]}
    )

    multiply_22 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: separate_xyz_14.outputs["Y"]},
        attrs={"operation": "MULTIPLY"},
    )

    subtract_12 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: multiply_22, 1: group_input_4.outputs["DoorHandleMargin"]},
        attrs={"operation": "SUBTRACT"},
    )

    op_not = nw.new_node(
        Nodes.BooleanMath,
        input_kwargs={0: group_input_4.outputs["DoorOnRight"]},
        attrs={"operation": "NOT"},
    )

    map_range_4 = nw.new_node(
        Nodes.MapRange, input_kwargs={"Value": op_not, 3: 1.0000, 4: -1.0000}
    )

    multiply_23 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: subtract_12, 1: map_range_4.outputs["Result"]},
        attrs={"operation": "MULTIPLY"},
    )

    combine_xyz_17 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": add_11, "Y": multiply_23}
    )
    ...
    store_named_attribute_5 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={"Geometry": transform_geometry_7, "Name": "joint6", "Value": 2},
        attrs={"data_type": "INT"},
    )
    ...
    separate_xyz_19 = nw.new_node(
        Nodes.SeparateXYZ, input_kwargs={"Vector": group_input_4.outputs["Size"]}
    )

    multiply_24 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: separate_xyz_19.outputs["X"]},
        attrs={"operation": "MULTIPLY"},
    )

    separate_xyz_20 = nw.new_node(
        Nodes.SeparateXYZ, input_kwargs={"Vector": combine_xyz_13}
    )

    subtract_13 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: separate_xyz_19.outputs["Y"], 1: separate_xyz_20.outputs["Y"]},
        attrs={"operation": "SUBTRACT"},
    )

    reroute_5 = nw.new_node(Nodes.Reroute, input_kwargs={"Input": op_not})

    map_range_5 = nw.new_node(
        Nodes.MapRange, input_kwargs={"Value": reroute_5, 3: -1.0000}
    )

    multiply_25 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: map_range_5.outputs["Result"]},
        attrs={"operation": "MULTIPLY"},
    )

    multiply_26 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: subtract_13, 1: multiply_25},
        attrs={"operation": "MULTIPLY"},
    )

    combine_xyz_14 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": multiply_24, "Y": multiply_26}
    )

    transform_geometry_6 = nw.new_node(
        Nodes.Transform,
        input_kwargs={"Geometry": join_geometry_2, "Translation": combine_xyz_14},
    )

    add_jointed_geometry_metadata_2 = nw.new_node(
        nodegroup_add_jointed_geometry_metadata().name,
        input_kwargs={"Geometry": transform_geometry_6, "Label": "door"},
    )
    ...
    multiply_27 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: separate_xyz_20.outputs["X"], 1: -0.5000},
        attrs={"operation": "MULTIPLY"},
    )

    multiply_28 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: separate_xyz_20.outputs["Y"]},
        attrs={"operation": "MULTIPLY"},
    )
    ...
    multiply_29 = nw.new_node(
        Nodes.Math,
        input_kwargs={0: multiply_28, 1: map_range_3.outputs["Result"]},
        attrs={"operation": "MULTIPLY"},
    )

    combine_xyz_15 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": multiply_27, "Y": multiply_29}
    )

    centerofgeometry_2 = nw.new_node(
        nodegroup_center_of_geometry().name,
        input_kwargs={"Geometry": twomaterialcube_1},
    )

    centerofgeometry_3 = nw.new_node(
        nodegroup_center_of_geometry().name, input_kwargs={"Geometry": join_geometry_2}
    )

    subtract_14 = nw.new_node(
        Nodes.VectorMath,
        input_kwargs={0: centerofgeometry_2, 1: centerofgeometry_3},
        attrs={"operation": "SUBTRACT"},
    )

    add_12 = nw.new_node(
        Nodes.VectorMath,
        input_kwargs={0: combine_xyz_15, 1: subtract_14.outputs["Vector"]},
    )

    combine_xyz_16 = nw.new_node(Nodes.CombineXYZ, input_kwargs={"Z": multiply_29})
    ...
    store_named_attribute_100 = nw.new_node(
        ...
        input_kwargs={
            "Geometry": join_geometry,
            "Name": "jointr",
            "Value": group_input_4.outputs["Value"],
        },
        attrs={"data_type": "INT"},
    )
...
class DoublefridgeFactory(AssetFactory):
    def __init__(self, factory_seed=None, coarse=False):
        super().__init__(factory_seed=factory_seed, coarse=False)
        self.sim_blueprint = blueprint_path_completion("doublefridge.json")
